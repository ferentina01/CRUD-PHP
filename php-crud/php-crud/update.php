...
require_once "connection.php";
    ...
    if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE users set  name='" . $_POST['name'] . "', mobile='" . $_POST['mobile'] . "' ,email='" . $_POST['email'] . "' ,Tanggallahir='" . $_POST['Tanggallahir'] . "' ,Tempatlahir='" . $_POST['Tempatlahir'] . "' ,Alamat='" . $_POST['Alamat'] . "' WHERE id='" . $_POST['id'] . "'");
